...
function fizzBuzz(numero) {
  ...
  var Nundiv3 = numero/3;
  var Nundiv5 = numero/5;
  if (Math.floor(Nundiv3)=== Nundiv3 && Math.floor(Nundiv5)=== Nundiv5 ){
    return "fizzbuzz";
  } else if (Math.floor(Nundiv3)=== Nundiv3){
      return "fizz";
  } else  if (Math.floor(Nundiv5)=== Nundiv5){
     return "buzz";
  }else {
    return numero;
  }
